...
__all__ = [
    'eLEXTYPE_PRIVATE15', 'SVPOver', 'SGDSActiveUserDelimited',
    'SAFTADPCM_11kHzMono', 'SDTRule', 'DISPID_SPIGetText',
    'SPSInterjection', 'DISPID_SRRAudioFormat',
    'SRSInactiveWithPurge', 'SDTAudio', 'UINT_PTR', 'DISPID_SBSRead',
    'SPWF_SRENGINE', 'SPRECOGNIZERSTATUS', 'ISpRecoGrammar2',
    'DISPID_SVSyncronousSpeakTimeout',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechPhraseProperties', 'SAFT44kHz8BitMono',
    'DISPID_SOTRemove', 'SPEI_TTS_PRIVATE',
    ...
    'ISpEventSink', 'SP_VISEME_11', 'SDA_Consume_Leading_Spaces',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SDKSetLongValue',
    'SpMMAudioEnum', 'DISPID_SASState', 'SAFT16kHz16BitMono',
    'SAFT32kHz16BitMono', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'ISpeechRecoResult2', 'DISPID_SPAsItem', 'SVSFDefault',
    'DISPID_SVSVisemeId', 'DISPID_SRRecognizer',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SpeechVoiceStatus',
    'SVEWordBoundary', 'ISpRecoContext2',
    'DISPID_SpeechRecognizerStatus', 'SPTEXTSELECTIONINFO',
    'DISPID_SRSetPropertyString', 'SPSLMA', 'SPPS_Noncontent',
    'SPWT_DISPLAY', 'SPEI_RECO_STATE_CHANGE', 'DISPID_SPEsItem',
    'SpeechWordPronounceable', 'SPEI_RESERVED6', 'DISPID_SRGCommit',
    'SPSUnknown', 'SRERecognition', 'eLEXTYPE_PRIVATE2',
    'SP_VISEME_15', 'SpeechGrammarWordType', 'eLEXTYPE_RESERVED10',
    'DISPID_SPISaveToMemory', 'SpeechRecognitionType',
    'DISPID_SRCResume', 'DISPID_SLWsCount',
    'DISPID_SVSInputWordLength', 'SVP_11', 'SPGS_EXCLUSIVE',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SGRSTsItem',
    'DISPID_SRRSaveToMemory', 'SDKLDefaultLocation', 'ISpNotifySink',
    'SAFT24kHz16BitMono', 'SECFEmulateResult', 'DISPID_SVResume',
    'SVEAudioLevel', 'SRTAutopause', 'SpAudioFormat',
    'SDTReplacement', 'SAFT16kHz8BitMono', 'DISPID_SVEAudioLevel',
    'ISpPhoneConverter', 'DISPID_SRGSetTextSelection',
    'SpeechRunState', 'DISPID_SpeechRecoContextEvents',
    'ISpeechLexiconWords', 'DISPID_SRGSetWordSequenceData',
    ...
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPEsCount', 'SITooFast',
    'SPVPRI_ALERT', 'DISPID_SVSkip', 'SVF_None', 'DISPID_SPRuleName',
    'SVPAlert', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SOTIsUISupported', 'DISPID_SRIsUISupported',
    'DISPID_SRRDiscardResultInfo', 'SPPS_Verb', 'SRARoot',
    'ISpPhoneticAlphabetSelection', 'SPGRAMMARWORDTYPE',
    'SPINTERFERENCE', 'SREPropertyStringChange', 'SREPhraseStart',
    'DISPID_SDKDeleteValue', 'SP_VISEME_3', 'DISPID_SRRTTickCount',
    'DISPID_SRGCmdLoadFromFile', 'SpeechTokenValueCLSID',
    'ISpSerializeState', 'DISPIDSPTSI_ActiveOffset',
    'SAFTADPCM_8kHzStereo', 'DISPIDSPTSI_SelectionOffset',
    'ISpeechPhraseElements', 'SECFDefault', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SPPsItem', 'DISPID_SRDisplayUI', 'DISPID_SGRsDynamic',
    'DISPID_SRRTLength', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPRDisplayAttributes', 'SRSInactive',
    'SDA_No_Trailing_Space', 'SAFTCCITT_ALaw_8kHzStereo',
    'IInternetSecurityManager', 'DISPID_SPIEnginePrivateData',
    'SGSExclusive', 'DISPID_SpeechObjectToken',
    'DISPID_SPPBRestorePhraseFromMemory', 'SINoSignal', 'SFTSREngine',
    'SECFIgnoreKanaType', 'SPEI_VOICE_CHANGE', 'SPPS_Interjection',
    'SpeechTokenKeyAttributes', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpeechMMSysAudio', 'SAFT11kHz8BitMono', 'SSSPTRelativeToEnd',
    'SPRECOCONTEXTSTATUS', 'SPPS_Modifier', 'SPEI_ADAPTATION',
    'DISPID_SPPConfidence', 'DISPID_SAEventHandle',
    'SPINTERFERENCE_TOOFAST', 'SPFM_OPEN_READONLY', 'SPVPRI_NORMAL',
    'SAFTDefault', 'DISPID_SLWsItem', 'SP_VISEME_12',
    'ISpObjectToken', 'DISPID_SAFType', 'SVEPrivate', 'SVP_12',
    'ISpeechFileStream', 'DISPID_SCSBaseStream', 'SPCT_SLEEP',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRGDictationSetState',
    'SAFTADPCM_44kHzMono', 'DISPID_SGRAddState',
    '_ISpeechRecoContextEvents',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SVP_9',
    'DISPID_SpeechPhraseRules', 'SBOPause', 'SpeechBookmarkOptions',
    'SPEI_END_SR_STREAM', 'SAFT8kHz16BitMono', 'ISpXMLRecoResult',
    'DISPID_SGRId', 'SP_VISEME_16',
    ...
    'SPEI_WORD_BOUNDARY', 'DISPID_SRCreateRecoContext',
    'SPWT_LEXICAL', 'SRSActiveAlways', 'SPGS_DISABLED', 'SPWORDTYPE',
    'SPWT_PRONUNCIATION', 'SPADAPTATIONRELEVANCE', 'ISpRecoResult',
    'DISPID_SPRuleFirstElement', 'SREHypothesis', 'DISPID_SVEPhoneme',
    'DISPID_SABufferNotifySize', 'DISPID_SPPChildren',
    'DISPID_SpeechWaveFormatEx', 'SpPhoneConverter',
    'SPEI_SR_AUDIO_LEVEL', 'SDKLCurrentConfig', 'SpeechPartOfSpeech',
    'DISPID_SBSWrite', 'DISPID_SPCLangId', 'ISpeechBaseStream',
    'DISPID_SFSOpen', 'STSF_AppData', 'SPWAVEFORMATTYPE',
    'SDKLLocalMachine', 'DISPID_SLPPartOfSpeech', 'DISPID_SASetState',
    'SAFT44kHz16BitStereo', 'SpeechVoicePriority', 'SECFIgnoreCase',
    'SDTAlternates', 'DISPID_SOTDisplayUI', 'SPAR_Low',
    'DISPID_SPEAudioSizeTime', 'SpeechTokenKeyFiles',
    'SREInterference', 'eLEXTYPE_PRIVATE9', 'SAFT22kHz16BitStereo',
    'DISPID_SpeechFileStream', 'DISPID_SRGetPropertyString',
    'SLODynamic', 'DISPID_SGRSAddWordTransition', 'DISPID_SVVoice',
    'SDKLCurrentUser', 'eLEXTYPE_PRIVATE7', 'SVP_15',
    'SRTExtendableParse', 'DISPID_SPEDisplayAttributes',
    'SAFT12kHz8BitMono', 'DISPID_SGRSTs_NewEnum', 'SPEI_SR_BOOKMARK',
    'SpeechTokenIdUserLexicon', 'DISPID_SPPValue', 'SVF_Emphasis',
    '_RemotableHandle', 'SRCS_Disabled', 'DISPID_SOTCEnumerateTokens',
    'SPWORDLIST', 'SVP_10', 'SVSFUnusedFlags', 'SPFM_CREATE_ALWAYS',
    'SPEI_HYPOTHESIS', 'DISPID_SpeechGrammarRuleStateTransition',
    'ISpRecoCategory',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPIElements', 'ISpNotifySource', 'SREStreamStart',
    'SPRST_NUM_STATES', 'SpeechAudioFormatGUIDText',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SVGetProfiles',
    'SAFTCCITT_ALaw_22kHzMono', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SVGetVoices', 'DISPID_SPPName', 'eLEXTYPE_PRIVATE11',
    'DISPID_SGRSTType', 'DISPID_SVSInputSentencePosition', 'SVP_20',
    'ISpeechXMLRecoResult', 'DISPID_SpeechDataKey',
    'SPEI_SENTENCE_BOUNDARY', 'eLEXTYPE_PRIVATE8',
    'DISPID_SVSLastResult', 'DISPIDSPRG', 'eLEXTYPE_PRIVATE18',
    'DISPID_SpeechAudioFormat', 'DISPID_SRRAlternates',
    'DISPID_SPEAudioStreamOffset', 'ISpeechPhraseElement',
    'SITooSlow', 'DISPID_SRCEInterference', 'DISPID_SLPsCount',
    'SPLO_DYNAMIC', 'DISPID_SPRules_NewEnum', 'SVP_7',
    'SAFT48kHz8BitMono', 'DISPID_SVPriority', 'DISPID_SPIRule',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SGRSTransitions',
    'ISpResourceManager', 'SpeechVoiceEvents',
    'DISPID_SPEDisplayText', 'SPAS_PAUSE', 'SPSHT_NotOverriden',
    'SECNormalConfidence', 'SSSPTRelativeToStart', 'SPEI_PHONEME',
    'SPPS_Function', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SpeechVoice', 'DISPID_SDKSetBinaryValue',
    'DISPID_SOTCreateInstance', 'DISPID_SWFEBitsPerSample',
    'DISPID_SGRsFindRule', 'STCLocalServer', 'SREPrivate',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SVAlertBoundary',
    'SDTPronunciation', 'DISPID_SRCEPhraseStart', 'SRAImport',
    'SPRST_ACTIVE_ALWAYS', 'SpNullPhoneConverter', 'SPSHORTCUTTYPE',
    ...
    'DISPID_SPRulesItem', 'SGSEnabled', 'SPSHT_Unknown',
    'SPEI_RECOGNITION', 'DISPID_SPEs_NewEnum',
    'SpeechRecognizerState', 'SAFT32kHz16BitStereo',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRCEAudioLevel',
    'DISPID_SPAs_NewEnum', 'DISPID_SRSAudioStatus',
    'DISPID_SRRTStreamTime', 'DISPID_SRCERequestUI',
    'DISPID_SDKEnumValues', 'DISPID_SASCurrentSeekPosition',
    'SpeechDiscardType', 'SAFTCCITT_uLaw_8kHzMono',
    'SAFT48kHz16BitMono', 'SPPS_NotOverriden', 'SPXMLRESULTOPTIONS',
    'SGRSTTRule', 'SVESentenceBoundary', 'DISPID_SRCPause',
    'SAFT48kHz8BitStereo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT16kHz8BitStereo', 'DISPID_SLPType', 'SAFT8kHz8BitStereo',
    'tagSPPROPERTYINFO', 'SDTProperty', 'DISPID_SPEPronunciation',
    'DISPID_SPPs_NewEnum', 'DISPID_SLWType', 'DISPID_SRGetFormat',
    'DISPID_SRGReset', 'DISPID_SpeechGrammarRules', 'SP_VISEME_7',
    'SPXRO_Alternates_SML', 'ISpeechPhoneConverter',
    'SPSEMANTICERRORINFO', 'DISPID_SpeechPhraseElement',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SLGenerationId',
    'SPEI_START_SR_STREAM', 'ISpRecognizer2', 'SECLowConfidence',
    'SPCT_DICTATION', 'DISPID_SpeechObjectTokens',
    'DISPID_SVSInputSentenceLength', 'SpeechMicTraining',
    'DISPID_SRRGetXMLResult', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPEI_SOUND_END', 'SAFT44kHz16BitMono',
    'DISPID_SRCEPropertyNumberChange', 'SAFT22kHz16BitMono',
    'SpeechPropertyAdaptationOn', 'SP_VISEME_19',
    'DISPID_SRCRetainedAudio', 'SpeechGrammarTagDictation',
    'DISPID_SRCRequestedUIType', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SGRsCommit', 'SpStreamFormatConverter',
    'DISPID_SGRSTNextState', 'SVSFlagsAsync', 'DISPID_SGRClear',
    'DISPID_SDKDeleteKey', 'SpPhoneticAlphabetConverter',
    'DISPID_SRGRecoContext', 'SP_VISEME_21', 'ISpeechPhraseAlternate',
    'DISPID_SPILanguageId', 'SPEI_START_INPUT_STREAM', 'SVP_21',
    'SPSFunction', 'SpMemoryStream', 'DISPID_SDKOpenKey',
    'eLEXTYPE_RESERVED9', 'SP_VISEME_6', 'SVP_1',
    'SpInProcRecoContext', 'ISpeechRecognizer', 'SRAORetainAudio',
    'ISpeechPhraseReplacement', 'DISPID_SPPFirstElement',
    'DISPID_SVVolume', 'SDTAll', 'SPWF_INPUT', 'SPCT_SUB_DICTATION',
    'DISPID_SLAddPronunciation', 'DISPID_SRState',
    'DISPID_SpeechLexiconWords', 'SVP_6', 'DISPID_SPAsCount',
    'SVSFIsNotXML', 'SVP_17', 'SPCS_ENABLED', 'SPEI_SOUND_START',
    'SAFTCCITT_ALaw_44kHzMono', 'SPDATAKEYLOCATION',
    'DISPID_SMSSetData', 'SREAudioLevel', 'SVSFIsXML',
    'DISPIDSPTSI_SelectionLength', 'ISpeechCustomStream',
    'SpeechWordType', 'SPEI_TTS_AUDIO_LEVEL', 'SASPause',
    'DISPID_SVDisplayUI', 'SpeechPropertyResourceUsage',
    'SAFTCCITT_ALaw_8kHzMono', 'SpWaveFormatEx',
    'SRERecoOtherContext', 'DISPID_SRAudioInput', 'eLEXTYPE_PRIVATE5',
    'ISpShortcut', 'SAFTExtendedAudioFormat',
    'DISPID_SLWPronunciations', 'DISPID_SVWaitUntilDone',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SRGIsPronounceable',
    'SP_VISEME_13', 'SPGS_ENABLED', 'SpeechAudioVolume',
    'SAFT22kHz8BitStereo', 'SRATopLevel', 'SPEI_TTS_BOOKMARK',
    'SpeechLoadOption', 'SpeechCategoryRecoProfiles',
    'eLEXTYPE_PRIVATE10', 'eLEXTYPE_RESERVED8', 'ISpAudio',
    'DISPID_SPIStartTime', 'DISPID_SVEventInterests', 'SVP_5',
    'SpeechDisplayAttributes', 'SSFMOpenReadWrite',
    'SpeechCategoryPhoneConverters', 'SPVISEMES',
    'ISpeechObjectToken', 'SpeechCategoryVoices', 'SpeechAllElements',
    'DISPID_SpeechGrammarRuleState', 'SAFTGSM610_8kHzMono',
    'DISPID_SPIGetDisplayAttributes', 'eLEXTYPE_RESERVED4',
    'SpeechStreamFileMode', 'SpeechCategoryRecognizers',
    'SGRSTTTextBuffer', 'SLTUser', 'SRSEIsSpeaking', 'DISPID_SVSpeak',
    'ISpeechLexiconPronunciation', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPFM_CREATE', 'SSTTWildcard', 'ISpeechPhraseInfo',
    'SpeechGrammarState', 'DISPID_SPRuleId',
    'DISPID_SRSSupportedLanguages', 'SGRSTTEpsilon', 'SWTDeleted',
    'SPEI_INTERFERENCE', 'DISPID_SVEStreamStart', 'SVEBookmark',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpeechAudioFormat',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SGRName',
    'DISPID_SpeechLexiconProns', 'DISPID_SGRSTsCount',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpeechRecoGrammar',
    'DISPID_SRGCmdLoadFromResource', 'SpeechCategoryAppLexicons',
    'SpeechRecoEvents', 'SPDKL_CurrentConfig', 'SVP_0',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SRRPhraseInfo',
    'SPAO_RETAIN_AUDIO', 'DISPID_SPPId', 'SRAONone',
    'SAFT48kHz16BitStereo', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechPhraseInfo', 'SWTAdded',
    'SRTStandard', 'SPWORD', 'SPRULE', 'DISPID_SPPsCount',
    'ISpProperties', 'SPEI_MAX_TTS', 'SAFT11kHz16BitMono',
    'SPLEXICONTYPE', 'SpMMAudioOut', 'SAFT32kHz8BitStereo',
    'DISPIDSPTSI', 'DISPID_SGRInitialState', 'DISPID_SRGState',
    'DISPID_SRGCmdLoadFromMemory', 'ISpeechResourceLoader',
    'DISPID_SLGetWords', 'SLTApp', 'eLEXTYPE_USER', 'SRESoundStart',
    'SpeechPropertyResponseSpeed', 'DISPID_SOTCDefault',
    'SpeechRegistryUserRoot', 'SPINTERFERENCE_NONE',
    'IInternetSecurityMgrSite', 'DISPID_SPIReplacements',
    'SPSERIALIZEDPHRASE', 'SPAUDIOSTATE', 'SpFileStream',
    'SREStreamEnd', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRGCmdSetRuleIdState', 'ISpeechTextSelectionInformation',
    'SPPS_Unknown', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPPHRASE',
    'DISPID_SPRuleConfidence', 'SRADefaultToActive', 'SVP_13',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SMSADeviceId', 'SPSNoun',
    'DISPID_SRSetPropertyNumber', 'SITooLoud', 'DISPID_SMSALineId',
    'SPSERIALIZEDRESULT', 'tagSPTEXTSELECTIONINFO', 'SPBO_NONE',
    'SPSSuppressWord', 'SpeechVoiceSkipTypeSentence', 'SVP_16',
    'SREAdaptation', 'DISPID_SPIEngineId', 'SRAInterpreter',
    'SVEViseme', 'ISpDataKey', 'DISPID_SRCCreateGrammar',
    'DISPID_SOTsItem', 'DISPID_SOTCSetId', 'SPSHT_EMAIL',
    'DISPID_SpeechVoiceEvent', 'DISPID_SDKCreateKey', 'SPVPRIORITY',
    'DISPID_SPRsItem', 'SVSFPurgeBeforeSpeak', 'SpeechRuleState',
    'SPPS_RESERVED2', 'DISPID_SpeechXMLRecoResult',
    'Speech_Default_Weight', 'DISPID_SWFEAvgBytesPerSec',
    'SPEVENTENUM', 'DISPID_SPIProperties',
    'DISPID_SVAudioOutputStream', 'DISPID_SGRsItem', 'DISPID_SVRate',
    'SDTDisplayText', 'DISPID_SPPNumberOfElements', 'SVPNormal',
    'Speech_StreamPos_RealTime', 'DISPID_SBSFormat',
    'DISPID_SGRSAddSpecialTransition', 'ISpeechLexicon',
    'STSF_CommonAppData', 'DISPID_SGRsAdd', 'SPDKL_CurrentUser',
    'SGSDisabled', 'DISPID_SRCEventInterests',
    'DISPID_SASCurrentDevicePosition', 'SPINTERFERENCE_TOOSLOW',
    'SSFMCreateForWrite', 'DISPID_SVSpeakStream',
    'DISPID_SLGetGenerationChange', 'DISPID_SLWs_NewEnum',
    'SAFTGSM610_44kHzMono', 'SPFM_NUM_MODES', 'SP_VISEME_14',
    'SPCT_COMMAND', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SOTDataKey', 'DISPID_SDKEnumKeys',
    'DISPID_SRRRecoContext', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SVEStreamEnd', 'DISPID_SRCCmdMaxAlternates',
    'SAFT11kHz8BitStereo', 'DISPID_SRCEEndStream',
    'eLEXTYPE_PRIVATE14', 'SpObjectToken',
    'SpeechEmulationCompareFlags', 'DISPID_SAStatus',
    'SpeechFormatType', 'DISPID_SRStatus', 'DISPID_SDKGetBinaryValue',
    'DISPID_SVEBookmark', 'DISPID_SPAStartElementInResult',
    'DISPID_SABIMinNotification', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SOTCId', 'DISPID_SRRTimes',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SVP_2', 'SGDisplay',
    'SPLOADOPTIONS', 'ISpeechGrammarRule', 'SPEI_RECO_OTHER_CONTEXT',
    'ISpStreamFormat', 'SITooQuiet', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SAFGuid', 'ISpeechGrammarRuleStateTransitions',
    'SpStream', 'SPFILEMODE', 'SpeechGrammarTagWildcard',
    'SpCustomStream', 'ISequentialStream', 'DISPID_SOTCategory',
    'SINone', 'SAFTADPCM_11kHzStereo', 'SGRSTTWord',
    'DISPID_SpeechPhraseElements', 'SPINTERFERENCE_NOISE',
    'ISpeechRecoResultDispatch', 'DISPID_SVGetAudioInputs',
    'SPVPRI_OVER', 'DISPID_SPIAudioSizeBytes', 'SPRULESTATE',
    'eLEXTYPE_PRIVATE19', 'SPDKL_LocalMachine', 'SPWORDPRONOUNCEABLE',
    'SAFT24kHz8BitMono', 'DISPID_SRCRetainedAudioFormat',
    'SpeechTokenKeyUI', 'DISPID_SpeechPhraseBuilder', 'SSTTDictation',
    'DISPID_SABufferInfo', 'SPAS_STOP', 'eLEXTYPE_PRIVATE6',
    'SAFT32kHz8BitMono', 'DISPID_SABIBufferSize', 'ISpeechRecoResult',
    'SpeechTokenShellFolder', 'DISPID_SPRuleChildren',
    'SpUnCompressedLexicon', 'SRCS_Enabled',
    'ISpeechObjectTokenCategory', 'SAFTCCITT_uLaw_8kHzStereo',
    'eLEXTYPE_PRIVATE12', 'DISPID_SVEWord', 'SVSFVoiceMask',
    'DISPID_SOTCGetDataKey', 'DISPID_SVSLastStreamNumberQueued',
    'eLEXTYPE_PRIVATE3', 'DISPID_SGRSTRule', 'SGDSActive',
    'DISPID_SpeechAudioStatus', 'SAFT12kHz16BitMono', 'SPAR_High',
    'ISpeechDataKey', 'SAFT24kHz8BitStereo', 'DISPID_SLWWord',
    'SpTextSelectionInformation', 'DISPID_SpeechRecoContext',
    'DISPID_SPRText', 'DISPID_SRCEEnginePrivate',
    'ISpeechRecognizerStatus', 'DISPID_SASFreeBufferSpace',
    'SPEI_END_INPUT_STREAM', 'DISPID_SPEEngineConfidence',
    'SpShortcut', 'DISPID_SVIsUISupported',
    'DISPID_SOTGetDescription', 'DISPID_SPRuleEngineConfidence',
    'Speech_Max_Word_Length', 'DISPID_SGRSTPropertyName',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRGRules',
    'DISPID_SRGetRecognizers', 'SVEPhoneme', 'SpeechCategoryAudioIn',
    'DISPID_SRSCurrentStreamPosition', 'SpeechDataKeyLocation',
    'SGLexical', 'SPEI_MAX_SR', 'ISpeechPhraseReplacements',
    'SpeechVoiceSpeakFlags', 'SPEI_RESERVED1', 'SGRSTTWildcard',
    'SRERequestUI', 'SpeechRuleAttributes', 'eLEXTYPE_PRIVATE4',
    'STSF_FlagCreate', 'ISpeechLexiconWord', 'SREStateChange',
    'ISpeechGrammarRuleStateTransition', 'SECFIgnoreWidth',
    'SPPS_RESERVED4', 'DISPID_SOTMatchesAttributes', 'ISpEventSource',
    'eLEXTYPE_RESERVED6', 'DISPID_SRCVoice',
    'SpeechRetainedAudioOptions', 'ISpeechWaveFormatEx',
    'DISPID_SRCEBookmark', 'SPPS_RESERVED3', 'SRSEDone',
    'DISPID_SABIEventBias', 'SDA_Two_Trailing_Spaces',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SVSInputWordPosition', 'SpObjectTokenCategory',
    'DISPID_SGRSTPropertyValue', 'SPCS_DISABLED',
    'SAFTADPCM_8kHzMono', 'SVSFParseSapi', 'SPXRO_SML', 'SPLO_STATIC',
    'SpeechAddRemoveWord', 'SREAllEvents', 'ISpObjectTokenCategory',
    'SWPUnknownWordPronounceable', 'SPAR_Medium',
    'ISpeechPhraseRules', 'SPRECOSTATE', 'SGDSInactive',
    'DISPID_SDKSetStringValue', 'SRSActive',
    'DISPID_SRRSetTextFeedback', 'DISPID_SFSClose',
    'eWORDTYPE_DELETED', 'SVSFPersistXML', 'SPWORDPRONUNCIATIONLIST',
    'SVSFNLPSpeakPunc', 'DISPID_SRProfile', 'SPPARTOFSPEECH',
    'SPCONTEXTSTATE', 'SPEI_FALSE_RECOGNITION', 'SPEI_MIN_TTS',
    'SVEStartInputStream', 'SVEEndInputStream',
    'SpeechSpecialTransitionType', 'DISPID_SRGId', 'SINoise',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRRAudio',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SVSLastBookmark', 'SPAS_RUN',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRCEHypothesis',
    'SVP_18', 'SBONone', 'STCRemoteServer',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRCEAdaptation', 'tagSTATSTG', 'ISpeechPhraseInfoBuilder',
    'eLEXTYPE_PRIVATE1', 'SPSEMANTICFORMAT',
    'ISpeechPhraseProperties', 'SpMMAudioIn',
    'DISPID_SVESentenceBoundary', 'SAFTGSM610_22kHzMono',
    'ISpeechAudioStatus', 'SAFT24kHz16BitStereo',
    'DISPID_SPEActualConfidence', 'IStream', 'DISPID_SPPParent',
    'SSTTTextBuffer', 'SECHighConfidence', 'DISPID_SPIGrammarId',
    'SRTSMLTimeout', 'eLEXTYPE_PRIVATE17', 'ISpVoice', 'ISpPhraseAlt',
    'DISPID_SRGDictationUnload', 'eLEXTYPE_PRIVATE16',
    'SAFT16kHz16BitStereo', 'DISPID_SPPEngineConfidence',
    'DISPID_SVStatus', 'eLEXTYPE_RESERVED7',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SWFESamplesPerSec',
    '_ISpeechVoiceEvents', 'DISPID_SPARecoResult',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SVEViseme', 'SPPHRASERULE',
    'SpPhraseInfoBuilder', 'ISpeechGrammarRules', 'SRTEmulated',
    'SPBO_AHEAD', 'SPRST_INACTIVE', 'SpInprocRecognizer',
    'DISPID_SPELexicalForm', 'SPBINARYGRAMMAR', 'SVP_3', 'SPAO_NONE',
    'SPPHRASEELEMENT', 'DISPID_SPRFirstElement', 'SVEVoiceChange',
    'DISPID_SRCBookmark', 'DISPID_SAFSetWaveFormatEx', 'SRAExport',
    'DISPID_SRCEFalseRecognition', 'SAFT44kHz8BitStereo',
    'SpeechRecoContextState', 'SAFT12kHz8BitStereo',
    'SGLexicalNoSpecialChars', 'WAVEFORMATEX',
    'DISPID_SRCERecognition', 'ISpObjectWithToken',
    'ISpStreamFormatConverter', 'SPPS_Noun', 'ISpeechPhraseRule',
    ...
    'SREPropertyNumChange', 'SpLexicon', 'DISPID_SLPs_NewEnum',
    'DISPID_SGRAddResource', 'ISpNotifyTranslator',
    'DISPID_SpeechBaseStream', 'IEnumSpObjectTokens',
    'eLEXTYPE_PRIVATE13', 'SP_VISEME_1', 'ISpeechAudio',
    'ISpeechPhraseAlternates', 'SAFTADPCM_22kHzMono',
    'ISpeechMemoryStream', 'SVF_Stressed', 'DISPID_SRRSpeakAudio',
    'SRADynamic', 'SPEI_RESERVED5', 'SP_VISEME_9',
    'DISPID_SPCIdToPhone', 'DISPID_SWFEFormatTag',
    'DISPID_SVAudioOutput', 'eWORDTYPE_ADDED', 'DISPID_SRCRecognizer',
    'SSSPTRelativeToCurrentPosition', 'SGRSTTDictation',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SVPause',
    'SGDSActiveWithAutoPause', 'SPWORDPRONUNCIATION',
    'SpeechRegistryLocalMachineRoot', 'IEnumString', 'SPEI_UNDEFINED',
    'SRESoundEnd', 'SpeechVisemeFeature', 'SPSTREAMFORMATTYPE',
    'SDA_One_Trailing_Space', 'SPPHRASEPROPERTY',
    'SpeechPropertyNormalConfidenceThreshold', 'SpeechLexiconType',
    'SAFTNonStandardFormat', 'STCInprocHandler',
    'DISPID_SpeechRecognizer', 'SPBOOKMARKOPTIONS',
    'SECFNoSpecialChars', 'SpeechAudioProperties', 'SFTInput',
    'SpeechEngineProperties', 'SVP_14', 'DISPID_SpeechLexicon',
    'SVP_19', 'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SGRSRule',
    'eLEXTYPE_APP', 'DISPID_SRGDictationLoad', 'SVP_4',
    'SPDKL_DefaultLocation', 'SPSNotOverriden', 'SVSFIsFilename',
    'SPSVerb', 'SREFalseRecognition', 'DISPID_SpeechPhraseRule',
    'SVSFParseSsml', 'DISPID_SREmulateRecognition',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'Speech_StreamPos_Asap', 'SPRS_INACTIVE', 'SPSModifier',
    ...
    'DISPID_SADefaultFormat', 'SSFMCreate',
    'SAFTCCITT_uLaw_22kHzStereo', 'SASStop', 'SDTLexicalForm',
    'SVP_8', 'DISPID_SPEAudioSizeBytes', 'SpNotifyTranslator',
    'eLEXTYPE_PRIVATE20', 'SAFT8kHz16BitStereo',
    'DISPID_SPERetainedSizeBytes', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SpeechRecoResult2', 'SPSHORTCUTPAIR', 'SPAUDIOOPTIONS',
    'SpeechDictationTopicSpelling', 'DISPID_SpeechRecoResult',
    ...
    'DISPID_SAVolume', 'SP_VISEME_0', 'SAFT8kHz8BitMono',
    'SP_VISEME_18', 'eLEXTYPE_MORPHOLOGY', 'SpeechAudioFormatType',
    'DISPID_SVGetAudioOutputs', 'DISPID_SGRSTText', 'SPAUDIOSTATUS',
    'SPPS_SuppressWord', 'ISpStream', 'SPEI_RESERVED3',
    'SPPS_RESERVED1', 'SPAR_Unknown', '__MIDL_IWinTypes_0009',
    'SPSMF_SRGS_SAPIPROPERTIES', 'Speech_Max_Pron_Length',
    'SP_VISEME_8', 'DISPID_SVEEnginePrivate',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRSClsidEngine', 'DISPID_SLPsItem', 'LONG_PTR',
    'DISPID_SDKGetStringValue', 'SpeechGrammarTagUnlimitedDictation',
    'SPBO_PAUSE', 'DISPID_SpeechLexiconPronunciation',
    'SPEI_SR_RETAINEDAUDIO', 'SAFTNoAssignedFormat',
    'DISPID_SpeechRecoResultTimes', 'ISpeechRecoResultTimes',
    'DISPID_SVEVoiceChange', 'DISPID_SRIsShared',
    'SPFM_OPEN_READWRITE', 'DISPID_SLWLangId', 'DISPID_SLPLangId',
    'ISpRecoGrammar', 'SP_VISEME_5', 'ISpeechPhraseProperty',
    'ISpRecoContext', 'SpeechInterference', 'ISpeechObjectTokens',
    'DISPID_SOTs_NewEnum', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPRsCount', 'SVSFNLPMask', 'SPCATEGORYTYPE',
    'DISPID_SLRemovePronunciation', 'ISpPhoneticAlphabetConverter',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpeechGrammarRuleState',
    'SP_VISEME_10', 'SpeechVisemeType', 'DISPID_SBSSeek',
    'SPEVENTSOURCEINFO', 'DISPID_SGRsCount', 'SP_VISEME_17',
    'SWPUnknownWordUnpronounceable', 'STCInprocServer',
    'DISPID_SpeechGrammarRule', 'DISPID_SOTsCount', 'SVSFParseMask',
    'SPEI_VISEME', 'SAFTCCITT_ALaw_11kHzStereo', 'SPRST_ACTIVE',
    'DISPID_SMSGetData', 'SLOStatic', 'SPEI_SR_PRIVATE',
    'DISPID_SPRs_NewEnum', 'SPAUDIOBUFFERINFO', 'ISpGrammarBuilder',
    'SREBookmark', 'DISPID_SRGetPropertyNumber',
    ...
    'SP_VISEME_20', 'SP_VISEME_2', 'SPGRAMMARSTATE',
    'DISPID_SVSRunningState', 'STCAll', 'DISPID_SPAPhraseInfo',
    'DISPID_SpeechAudio', 'SPSHT_OTHER', 'SPCT_SUB_COMMAND',
    'SPRS_ACTIVE', 'ISpPhrase', 'DISPID_SPCPhoneToId',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SpeechPhraseAlternates',
    'SPPHRASEREPLACEMENT', 'DISPID_SRGCmdLoadFromObject',
    'ISpeechVoiceStatus', 'DISPID_SRCAudioInInterferenceStatus',
    'ISpeechRecoContext', 'ISpeechVoice', 'SASRun', 'SPVOICESTATUS',
    'SAFTText', 'ISpLexicon', 'DISPID_SDKGetlongValue',
    'SPBO_TIME_UNITS', 'DISPID_SWFEChannels',
    'DISPID_SpeechPhraseAlternate', 'SpSharedRecoContext',
    'DISPID_SpeechLexiconWord', 'DISPID_SVSPhonemeId',
    'SAFT11kHz16BitStereo', 'SPEI_MIN_SR', 'SpVoice',
    'DISPID_SWFEBlockAlign', 'SPRECORESULTTIMES', 'SGPronounciation',
    ...
    'SAFT12kHz16BitStereo', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPACommit',
    'DISPID_SLPSymbolic', 'ISpRecognizer',
    'SpeechAudioFormatGUIDWave', 'SPEI_RESERVED2', 'SPSMF_UPS',
    'SPPROPERTYINFO', 'DISPID_SGRsCommitAndSave',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SOTSetId',
    'DISPID_SGRSTWeight', 'SAFTGSM610_11kHzMono', 'SPEVENT',
    'DISPID_SOTId', 'DISPID_SpeechMemoryStream',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SLPPhoneIds',
    'SpeechGrammarRuleStateTransitionType', 'SPEI_REQUEST_UI',
    'DISPID_SGRAttributes', 'SpeechTokenContext',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SLGetPronunciations',
    'SPAS_CLOSED', 'SRTReSent', 'DISPID_SpeechCustomStream',
    'SVEAllEvents', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechAudioState', 'SPEI_PHRASE_START', 'SPPS_LMA'
]

_check_version('1.2.0', 1662606486.568615)
